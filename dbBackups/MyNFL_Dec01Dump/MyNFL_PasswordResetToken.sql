...
CREATE TABLE `PasswordResetToken` (
  ...
  KEY `idx_password_reset_person` (`personId`),
  CONSTRAINT `fk_password_reset_person` FOREIGN KEY (`personId`) REFERENCES `Person` (`pid`) ON DELETE CASCADE ON UPDATE CASCADE
