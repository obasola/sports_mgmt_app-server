...
CREATE TABLE `player_statistics` (
  ...
  `category` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'e.g., passing, rushing, receiving, defense',
  `stat_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `stat_value` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'String to handle both numeric and text values',
  `season_year` year DEFAULT NULL,
  `season_type` enum('REGULAR','PLAYOFFS','PRESEASON') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-12-01 10:24:56
