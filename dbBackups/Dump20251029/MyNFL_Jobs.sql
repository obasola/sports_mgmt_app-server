...
CREATE TABLE `Jobs` (
  ...
  `type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Job type: PF_DRAFT_SCRAPER, ESPN_PLAYER_IMPORT, etc.',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING, RUNNING, COMPLETED, FAILED, CANCELLED',
  ...
  `error` text COLLATE utf8mb4_unicode_ci COMMENT 'Error message if job failed',
  `createdBy` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'User who created the job',
